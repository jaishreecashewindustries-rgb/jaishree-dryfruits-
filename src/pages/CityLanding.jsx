...
export const CITIES = {
  ...
  coimbatore: { name: "Coimbatore", state: "Tamil Nadu", tier: "tier2", days: "3-5" },
  kochi: { name: "Kochi", state: "Kerala", tier: "tier2", days: "3-5" },
  chandigarh: { name: "Chandigarh", state: "Chandigarh", tier: "tier2", days: "3-5" },
  ludhiana: { name: "Ludhiana", state: "Punjab", tier: "tier2", days: "3-5" },
  agra: { name: "Agra", state: "Uttar Pradesh", tier: "tier2", days: "3-5" },
  nashik: { name: "Nashik", state: "Maharashtra", tier: "tier2", days: "3-5" },
  faridabad: { name: "Faridabad", state: "Haryana", tier: "metro", days: "2-3" },
  meerut: { name: "Meerut", state: "Uttar Pradesh", tier: "tier2", days: "3-5" },
  rajkot: { name: "Rajkot", state: "Gujarat", tier: "tier2", days: "3-5" },
  varanasi: { name: "Varanasi", state: "Uttar Pradesh", tier: "tier2", days: "3-5" },
  amritsar: { name: "Amritsar", state: "Punjab", tier: "tier2", days: "3-5" },
  prayagraj: { name: "Prayagraj", state: "Uttar Pradesh", tier: "tier2", days: "3-5" },
  ranchi: { name: "Ranchi", state: "Jharkhand", tier: "tier2", days: "3-5" },
  jodhpur: { name: "Jodhpur", state: "Rajasthan", tier: "tier2", days: "2-3" },
  gwalior: { name: "Gwalior", state: "Madhya Pradesh", tier: "tier2", days: "3-5" },
  vijayawada: { name: "Vijayawada", state: "Andhra Pradesh", tier: "tier2", days: "3-5" },
  madurai: { name: "Madurai", state: "Tamil Nadu", tier: "tier2", days: "3-5" },
  raipur: { name: "Raipur", state: "Chhattisgarh", tier: "tier2", days: "3-5" },
  kota: { name: "Kota", state: "Rajasthan", tier: "tier2", days: "2-3" },
  guwahati: { name: "Guwahati", state: "Assam", tier: "tier2", days: "5-7" },
  dehradun: { name: "Dehradun", state: "Uttarakhand", tier: "tier2", days: "3-5" },
  jabalpur: { name: "Jabalpur", state: "Madhya Pradesh", tier: "tier2", days: "3-5" },
  aurangabad: { name: "Aurangabad", state: "Maharashtra", tier: "tier2", days: "3-5" },
  noida: { name: "Noida", state: "Uttar Pradesh", tier: "metro", days: "2-3" },
  mysore: { name: "Mysore", state: "Karnataka", tier: "tier2", days: "3-5" },
};
